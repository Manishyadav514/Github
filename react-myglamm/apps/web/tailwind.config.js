...
const extend = {
  ...
  backgroundImage: {
    ...
    "title-pattern": "linear-gradient(180deg,transparent 60%,var(--color1) 30px)",
  },
  maxHeight: { "75vh": "75vh" },
  minWidth: { 85: "85%" },
  boxShadow: {
    combo: "0 0 4px 0 rgba(0, 0, 0, 0.22)",
    checkout: "0 0 3px 0 rgba(0,0,0,.19)",
    shadowCmn: "0 0 4px 0 rgba(0,0,0,.24)",
  },
  borderWidth: { 3: "3px" },
...
module.exports = {
  ...
  theme: {
    extend,
    fontFamily: {
      body: ["var(--gbcfont)", "Roboto", "system-ui", "Arial", "Helvetica", "sans-serif"],
    },
  },
