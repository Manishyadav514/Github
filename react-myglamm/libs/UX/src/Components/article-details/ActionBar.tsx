...
const ActionBar = (props: PropTypes) => {
  ...
  const countClass = "text-sm font-medium";
  const labelClass = "text-xs font-normal text-gray-600";
  ...
  const onSettingClick = (e: React.MouseEvent<HTMLDivElement, MouseEvent>, id: string) => {
    e.stopPropagation();
    if (id === "chat") {
        ...
        <div className="flex justify-between w-5/6">
          <div
            ...
            onClick={e => {
              // e.preventDefault();
              // setActiveModal("like");
              // GAgenericEvent("engagement", "BBC Download Popup Viewed", "like");
            }}
          >
          ...
          <div
            ...
            onClick={e => {
              ...
              // GAgenericEvent("engagement", "BBC Download Popup Viewed", "bookmark");
            }}
          >
