...
const CommentInput = (props: PropTypes) => {
  ...
  const postCommentAPICall = async (meta = null) => {
    ...
    GAgenericEvent("Content & Community", "BBC Write A Comment", articleId);
      ...
      <div className="flex center mb-3">
        ...
        >
          ...
          <div className="absolute right-6 w-6 h-6 top-1/2 -translate-y-1/2" onClick={handleClick}>
            <ImageComponent src={getStaticUrl("/images/bbc-g3/gallery.svg")} alt="gallery" width="100%" height="100%" />
        ...
        <div className="w-10 h-10 relative cursor-pointer flex items-center" onClick={onSendComment}>
          <ImageComponent src={getStaticUrl("/images/bbc-g3/desktop-send.svg")} alt="send-btn" width="100%" height="100%" />
        </div>
      </div>
