...
const OrderSuccessTWK = ({ orderStatus, orderDetails }: successProps) => {
      ...
      <div>
        ...
        <div className="py-2 bg-white text-center rounded-t-2xl">
          ...
          <div className="border-t border-gray-200 flex font-semibold p-2 justify-between bg-white text-center sticky bottom-0">
            <Link href="/my-orders" style={{ width: "48.5%" }} className="border py-3 px-5">
              {t("trackMyOrder")}
            </Link>
            <Link
...
export default OrderSuccessTWK;
