...
const OrderSuccessPopxo = ({ orderStatus, orderDetails }: successProps) => {
      ...
      <div>
        ...
        <div className="py-2 bg-white text-center rounded-t-2xl">
          <div className="px-5">
            ...
            >
              <GoodPointsCoinIcon className="h-6 w-6" />
            ...
            >
              ...
              <div className="text-sm text-left tracking-tight leading-relaxed w-4/5">
                ...
                <p className="text-xs opacity-75 paraText">{t("communityItemSubtitle")}</p>
              </div>
              <Arrow className="w-4 h-2.5" />
            </a>
          </div>
          ...
          <div className="border-t border-gray-200 flex font-semibold p-2 justify-between bg-white text-center sticky bottom-0">
            <Link href="/my-orders" style={{ width: "48.5%" }} className="border py-3 px-5" aria-label={t("trackMyOrder")}>
              {t("trackMyOrder")}
            </Link>
            <Link
...
export default OrderSuccessPopxo;
