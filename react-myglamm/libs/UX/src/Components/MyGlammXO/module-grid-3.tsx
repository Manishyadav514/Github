...
const ModuleGrid3 = ({ data }: any) => {
  ...
  return (
    <div className="py-4">
      ...
      <img src="https://files.myglamm.com/site-images/original/myGlammXO.png" alt="" className="mx-auto mb-6" />
              ...
              <div className="productInfo">
                ...
                <div className="font-semibold flex text-sm">
                  <div className="w-2/3 m-auto">
                    <span className="mr-1">{formatPrice(prod.offerPrice)}</span>
                    {prod.price > prod.offerPrice && <del className="text-xs opacity-25">{formatPrice(prod.price)}</del>}
                  </div>
