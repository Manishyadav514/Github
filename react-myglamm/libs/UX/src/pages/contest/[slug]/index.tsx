  ...
  return (
    <main>
      <Head>
        ...
        <meta name="description" key="description" content={`${currentContest?.contestName} |  Contest Entry`} />
        <meta property="og:description" key="og:description" content={`${currentContest?.contestName} |  Contest Entry`} />
        <link
          rel="canonical"
          key="canonical"
