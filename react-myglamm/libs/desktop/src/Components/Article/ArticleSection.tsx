...
import AuthorHeader from "../../Components/common/AuthorHeader";
...
import OtherReviewer from "../../Components/Article/OtherReviewer";
...
const ArticleSection = () => {
  ...
  const getProductObjFromElement = (event: any) => {
    const htmlElement = event?.target?.closest(".MyGlammXOProducts") || event?.target?.closest(".g3-products");
    const productObj = {
