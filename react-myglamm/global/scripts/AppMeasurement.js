...
function AppMeasurement(r) {
  ...
  a.foreachVar = function (c, b) {
    ...
    if (a.lightProfileID) (d = a.N), (k = a.lightTrackVars) && (k = "," + k + "," + a.ka.join(",") + ",");
      ...
      if (a.pe || a.linkType)
        (k = a.linkTrackVars),
          (f = a.linkTrackEvents),
          a.pe && ((e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1)), a[e] && ((k = a[e].cc), (f = a[e].bc)));
      k && (k = "," + k + "," + a.D.join(",") + ",");
      f && k && (k += ",events,");
    }
    b && (b = "," + b + ",");
  ...
  a.Pb = function () {
    ...
    if (a.lightProfileID) (b = a.N), (n = a.lightTrackVars) && (n = "," + n + "," + a.ka.join(",") + ",");
      ...
      if (a.pe || a.linkType)
        (n = a.linkTrackVars),
          (m = a.linkTrackEvents),
          a.pe && ((e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1)), a[e] && ((n = a[e].cc), (m = a[e].bc)));
      n && (n = "," + n + "," + a.D.join(",") + ",");
      m && ((m = "," + m + ","), n && (n += ",events,"));
  ...
  a.u = function (c) {
    var b, d;
    for (b in a.P)
      if (!Object.prototype[b] && (d = a.P[b]) && (d._olc && d.onLoad && ((d._olc = 0), d.onLoad(a, d)), d[c] && d[c]()))
        return 1;
    return 0;
  };
  a.Tb = function () {
      ...
      a.account &&
        ...
        a.Qb() &&
          ...
          (e &&
            ...
            (a.supplementalDataID = e.getSupplementalDataID("AppMeasurement:" + a._in, a.expectSupplementalData ? !1 : !0)),
  ...
  a.Zb = function (c) {
    ...
    !b &&
      ...
      b && ((a.AudienceManagement && a.AudienceManagement.isReady()) || 0 != a.usePostbacks) && (a.W ? (b.Ga = !0) : (b = 0)));
      ...
      if ((d = a._il[b]) && "s_l" == d._c && d.tagContainerName == c) {
        ...
        if (d.mmq)
          for (b = 0; b < d.mmq.length; b++)
            (f = d.mmq[b]),
              a[f.m] && ((c = a[f.m]), c[f.f] && "function" == typeof c[f.f] && (f.a ? c[f.f].apply(c, f.a) : c[f.f].apply(c)));
...
var e = (function () {
    ...
    var r = function (e) {
        ...
        o(function () {
          ...
          (arguments.length > 1 ? arguments[1] : void 0) &&
            ...
            a(function () {
              var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
              (arguments.length > 1 ? arguments[1] : void 0) && ((s.consentString = e.consentData), i("allConsentData", s)),
  ...
  var C,
      ...
      (n.isObjectEmpty = function (e) {
        ...
        (n.getIeVersion = function () {
          ...
          for (var e = 7; e > 4; e--) {
            ...
            if (
              ((t.innerHTML = "\x3c!--[if IE " + e + "]><span></span><![endif]--\x3e"), t.getElementsByTagName("span").length)
            )
              return (t = null), e;
            t = null;
          }
    ...
    $ = function (e) {
      ...
      for (n = i.length - 2; n >= 0; n--)
        if (((t = i.slice(n).join(".")), Q.set("test", "cookie", { domain: t }))) return Q.remove("test", { domain: t }), t;
      return "";
    },
    Z = {
      compare: s,
          ...
          return (
            "undefined" != typeof XMLHttpRequest &&
              ...
              ("withCredentials" in new XMLHttpRequest()
                ? (e = "XMLHttpRequest")
                : "undefined" != typeof XDomainRequest && XDomainRequest === Object(XDomainRequest) && (t = !1),
    ...
    ae = function (e, t) {
      ...
      return {
        ...
        requestToProcess: function (t) {
          ...
          if (
            (this.receivedThirdPartyCookiesNotification || !re.POST_MESSAGE_ENABLED || this.iframeHasLoaded) &&
        ...
        pruneSyncData: function (e, t, n) {
          ...
          for (r = 0; r < e.length; r++)
            (i = e[r]),
              ...
              i.match("^" + t + "-") ? ((o = !0), n < a ? (s = !0) : (e.splice(r, 1), r--)) : n >= a && (e.splice(r, 1), r--);
          ...
          (null == this.url || (i.subdomain && "nosubdomainreturned" === this.subdomain)) &&
            ...
            this.readyToAttachIframe() &&
              (e.idSyncAttachIframeOnWindowLoad
                ? (t.windowLoaded || "complete" === n.readyState || "loaded" === n.readyState) && this.attachIframe()
    ...
    He = function (e, t) {
      e.publishDestinations = function (n) {
        ...
        if ("string" == typeof n) {
          ...
          if (!(i instanceof Array && i.length)) return void r({ error: "messages is not a populated array." });
          var o = !1;
          if (
        ...
        a.iframe
          ? (r({ message: "The destination publishing iframe is already attached and loaded." }), a.requestToProcess())
          ...
          var _ = m[i - 15],
            ...
            S =
              ...
              (m[i] =
                i < 16
                  ? m[i]
                  : (m[i - 16] + (n(_, 7) ^ n(_, 18) ^ (_ >>> 3)) + m[i - 7] + (n(C, 17) ^ n(C, 19) ^ (C >>> 10))) | 0);
  ...
  var qe = function (t, n, i) {
    ...
    function f() {
      m.optIn.isApproved(m.optIn.Categories.ECID) &&
        (g.configs.isIabContext ? m.optIn.execute({ command: "iabPlugin.fetchConsentData", callback: d }) : (g.init(), p()));
    }
    function p() {
    ...
    (g.FIELDS = E.FIELDS),
      ...
      (g.setCustomerIDs = function (t, n) {
        ...
        if (!g.isOptedOut() && t) {
          ...
          c || (c = 0);
          for (r in l)
            L(r) && ((a = l[r]), (u += (u ? "|" : "") + r + "|" + (a.id ? a.id : "") + (a.authState ? a.authState : "")));
    ...
    (g._liberatedOptOut = null),
      ...
      (g._attemptToPopulateSdidFromUrl = function (e) {
        ...
        n && n.TS && (i = w.getTimestampInSeconds() - n.TS),
          n &&
            ...
            n.MCORGID === t &&
            i < g.sdidParamExpiry &&
            ((g._supplementalDataIDCurrent = n.SDID), (g._supplementalDataIDCurrentConsumed.SDID_URL_PARAM = !0));
      }),
          ...
          if (
            ...
            for (
              ...
              (t = l[e].split("-")),
                (n = t[0]),
                (i = l[e + 1]),
                t.length > 1 ? ((r = parseInt(t[1], 10)), (a = t[1].indexOf("s") > 0)) : ((r = 0), (a = !1)),
      ...
      (g._findVisitorID = function (t) {
        return (
          t &&
            ("object" === e(t) && (t = t.d_mid ? t.d_mid : t.visitorID ? t.visitorID : t.id ? t.id : t.uuid ? t.uuid : "" + t),
      ...
      (g._setFields = function (t, n) {
        if (
          (g._clearTimeout(t), null != g._loading && (g._loading[t] = !1), N.fieldGroupObj[t] && N.setState(t, !1), "MC" === t)
        ) {
          ...
          if (!i || g.overwriteCrossDomainMCIDAndAID) {
            if (!(i = "object" === e(n) && n.mid ? n.mid : g._findVisitorID(n))) {
              if (g._use1stPartyMarketingCloudServer && !g.tried1stPartyMarketingCloudServer)
                return (g.tried1stPartyMarketingCloudServer = !0), void g.getAnalyticsVisitorID(null, !1, !0);
        ...
        if (t === M && "object" === e(n)) {
          ...
          var o = g._getField(k);
          (n.d_blob || n.blob) && ((o = n.d_blob), o || (o = n.blob), g._setFieldExpire(k, r), g._setField(k, o)),
            o || (o = ""),
        ...
        if (t === b) {
          ...
          (s && !g.overwriteCrossDomainMCIDAndAID) ||
            ((s = g._findVisitorID(n)), s ? s !== T && g._setFieldExpire(k, -1) : (s = T), g._setField(O, s)),
            (s && s !== T) || (s = ""),
      ...
      (g._getRemoteField = function (e, t, n, i, r) {
        ...
        if (u() && g.isAllowed()) {
          ...
          if (
            ...
            if ((e === A || "MCOPTOUT" === e ? (a = "MC") : "MCAAMLH" === e || e === k ? (a = M) : e === O && (a = b), a))
              return (
                !t ||
                  ...
                  g._loadData(
                    ...
                    function (t) {
                      if (!g._getField(e)) {
                        t && N.setState(a, !0);
                        var n = "";
                        e === A ? (n = g._generateLocalMID()) : a === M && (n = { error_msg: "timeout" }), g._setFields(a, n);
                      }
                    },
                    r
                  )),
            ...
            o ||
              (e === A
                ? (g._registerCallback(e, n), (o = g._generateLocalMID()), g.setMarketingCloudVisitorID(o))
                : e === O
        ...
        if ((g.loadSSL && g.audienceManagerServerSecure && (t = g.audienceManagerServerSecure), t)) {
          ...
          var u = "http" + (g.loadSSL ? "s" : "") + "://" + t + "/id",
            d =
              ...
              o,
            f = ["s_c_il", g._in, e];
          return (n = u + "?" + d + "&d_cb=s_c_il%5B" + g._in + "%5D." + e), { url: n, corsUrl: u + "?" + d, callback: f };
        }
        return { url: n };
      }),
    ...
    var w = {
      ...
      isFirstPartyAnalyticsVisitorIDCall: function (e, t, n) {
        ...
        return (
          ...
          !("string" != typeof (i = g.loadSSL ? n : t) || !i.length) && i.indexOf("2o7.net") < 0 && i.indexOf("omtrdc.net") < 0
        );
      },
      isObject: function (e) {
    ...
    (g.isClientSideMarketingCloudVisitorID = function () {
      ...
      (function () {
        if (((g.configs = Object.create(null)), w.isObject(n))) for (var e in n) L(e) && ((g[e] = n[e]), (g.configs[e] = n[e]));
      })(),
      (function () {
        [
        ...
        !(function () {
          ...
          (function () {
            g.whitelistIframeDomains &&
              re.POST_MESSAGE_ENABLED &&
              ((g.whitelistIframeDomains =
                g.whitelistIframeDomains instanceof Array ? g.whitelistIframeDomains : [g.whitelistIframeDomains]),
